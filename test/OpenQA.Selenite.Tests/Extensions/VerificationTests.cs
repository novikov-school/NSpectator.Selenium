...
using OpenQA.Selenite.Exceptions;
...
namespace OpenQA.Selenite.Tests.Extensions
{
    ...
    public class VerificationTests
    {
        ...
        public void
            Given_value_and_verification_and_predicate_that_fails_when_verifying_should_throw_exception_with_verification_message
            (string verification, string verificationMessage)
        {
        ...
        public void Given_selection_verification_fails_when_verifying_selected_should_throw_exception(bool expected)
        {
            ...
            action
                ...
                .WithMessage(string.Format("Selection verification failed. Expected: {0}, Actual: {1}.", expected,
                    element.Selected));
        }
        ...
        public void Given_assertion_that_fails_should_throw()
        {
            ...
            Action assertion = () => { throw new AssertionException(expectedMessage); };
        ...
        [Test]
        public void
            Given_verification_on_IClickable_and_take_screenshot_is_false_When_verification_fails_Then_screenshot_is_not_taken
            ()
        {
        ...
        [Test]
        public void
            Given_verification_on_IClickable_and_take_screenshot_is_false_When_verification_succeeds_Then_screenshot_is_not_taken
            ()
        {
            var driver = Substitute.For<IWebDriver>();
            var driverEnvironment = Substitute.For<IDriverEnvironment>();
