...
using OpenQA.Selenite.Tests.Shared.Pages;
using OpenQA.Selenite.Tests.Shared.Sessions;
...
namespace OpenQA.Selenite.Tests.Setup
{
    ...
    public class ThreadedSessionTests
    {
        ...
        [Test]
        public void
            Given_multiple_sessions_in_single_thread_When_loading_with_drivers_Then_should_maintain_distinct_sessions()
        {
        ...
        [Test]
        public void
            Given_session_already_loaded_When_loading_with_another_driver_Then_should_end_previous_session_driver_and_return_session_with_correct_driver
            ()
        {
        ...
        [Test]
        public void
            Given_session_already_loaded_with_navigation_When_getting_matching_current_block_Then_should_return_block()
        {
            Threaded<Session>
                .With<PhantomJS>()
        ...
        public void Given_session_type_with_wrong_constructor_args_When_loading_with_driver_Then_should_throw()
        {
            ...
            var expectedMessage = string.Format(Threaded<DerivedSessionWithWrongArgs>.InvalidSessionTypeFormat,
                typeof (DerivedSessionWithWrongArgs));
        ...
        [Test]
        public void
            When_loading_with_generic_driver_Then_should_return_session_with_correct_driver_with_default_settings()
        {
            Threaded<Session>
                .With<PhantomJS>()
                .Verify(x => x.Driver is PhantomJSDriver)
