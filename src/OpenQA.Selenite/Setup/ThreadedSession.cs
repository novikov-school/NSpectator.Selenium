...
namespace OpenQA.Selenite.Setup
{
    ...
    public class Threaded<TSession> where TSession : Session
    {
        ...
        /// <summary>
        ///     Allows the creation of a Session-based type using a type derived from IDriverEnvironment that the system can
        ///     initialize with a parameterless constructor.
        /// </summary>
